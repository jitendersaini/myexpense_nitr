...
public class CustomUserDetailsService implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username)
		...
		try {
			...
			//Query query = new Query(Criteria.where("username").is(username).orOperator(Criteria.where("email").is(username)));
			/*Query query = new Query(Criteria.where("username").is(username).orOperator(Criteria.where("email").is(username)));
			List<Users> listUser = mongoTemplate.find(query, Users.class);*/
			...
			// Spring's User
			/*Users dbUser = userRepository.findByUsernameOrEmail(username, username);*/
